...
The SMART Health Card Verifier API provides clients an interface to perform validation on a SMART Health Card, ensuring that the SMART Health Card has not been tampered with. If the SMART Health Card passes validation, the payload of the SMART Health Card will be returned to the client. Additionally, if the issuer of the SMART Health Card is registered in the CommonTrust Network Registry, the issuer information is returned alongside the SMART Health Card payload. 
